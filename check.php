...
<form action="send_email.php" method="post" id="myform">
    ...
    <table class="checklist">
        ...
        <tr>
            ...
            <td><input type="email" id="email" name="email" placeholder="xihwang@gmail.com" required></td>
        </tr>
    </table>
    <div style="text-align: center">
        <button type="submit" name="purchase" id="Purchase_id" >Purchase</button>
    </div>
</form>
<script>
